    ...
    <html lang="en">
      <body className="w-full h-full">
        <div className="h-[50pt] w-full shadow-sm border-b border-gray-200 flex flex-row gap-4 items-center justify-between px-8">
          <div className="text-3xl font-bold text-gray-800"><span className="pr-1">🎲</span>UTN FRC - SIM</div>
          <div className="text-xl font-bold text-gray-800">Trabajo Práctico Final</div>
        </div>
